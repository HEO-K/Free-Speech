function [ img_grappa, mask, mask_acs ] = grappa_1d_vc( kspace_sampled, kspace_acs, Ry, acs_size, kernel_size, lambda_tik )
...
Rhs = zeros([num_ind, num_chan * 2, Ry-1]);
...
weights = zeros([prod(kernel_size) * num_chan * 2, num_chan * 2, Ry-1]);
