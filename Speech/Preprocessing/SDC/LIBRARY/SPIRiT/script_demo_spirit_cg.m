...
figure, imagesc(cat(1,cat(2,im_sqr,im_dc_sqr),cat(2,im_cgspirit_sqr,im_grappa_sqr)), [0,0.4]); axis image off, colormap gray
title ('top-left:Full		top-right:zero-fill w/dc	bottom-left:SPIRiT 	 	bottom-right:GRAPPA');
figure, imagesc(cat(2,im_cgspirit_err_sqr,im_grappa_err_sqr)); axis image off, colormap gray
