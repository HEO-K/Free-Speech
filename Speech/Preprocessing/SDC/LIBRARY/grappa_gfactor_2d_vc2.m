function [ img_grappa, mask, mask_acs, image_weights, g_fnl ] = grappa_gfactor_2d_vc2( kspace_sampled, kspace_acs, Rx, Ry, acs_size, kernel_size, lambda_tik, weights_p )
...
image_weights = zeros([N, num_chan*2, num_chan]);
