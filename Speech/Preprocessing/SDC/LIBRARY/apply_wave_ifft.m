function [ res, tflag ] = apply_wave_ifft( in, params, tflag )
...
if strcmp(tflag,'transp');
    ...
    Temp = fftshift(fft(fftshift(Im .* conj(params.psfs),1),[],1),1) ./ sqrt(params.psf_len);
    ...
    Img_conv = fftshift(ifft(fftshift(Img,1), [], 1), 1) .* params.psfs .* sqrt(params.psf_len);    
