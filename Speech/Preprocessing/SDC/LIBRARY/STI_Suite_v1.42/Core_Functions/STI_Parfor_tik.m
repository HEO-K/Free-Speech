function [X_tensor]=STI_Parfor_tik(Thetai,HVector,parallel_Flag,tik)
% Wei Li, PhD
% Chunlei Liu, PHD
...
parfor loopvar = 1:poolnum
    warning off all
    xkipar{loopvar}=myparforfun(kipar{loopvar}, A1, H, thetai0par{loopvar}, loopvar, tik);
end
clear kipar
...
function xki = myparforfun(ki, A1, H, thetai0, loopvar, tik)
SZ1 = size(ki,1);
tic
xki = zeros(SZ1,6);
