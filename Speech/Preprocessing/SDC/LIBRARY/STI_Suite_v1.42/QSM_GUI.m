...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
HARPERELLA_Function(hObject,handles,'VSHARP')
...
% --- Executes on button press in UseMask.
function UseMask_Callback(hObject, eventdata, handles)

UniqueID=get(handles.UniqueID,'string');
set(handles.BrainMaskName,'string',[UniqueID '_MyMask']);


% hObject    handle to UseMask (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
