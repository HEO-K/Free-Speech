...
mkdir(ses_folder);
afile = fullfile(ses_folder, strcat('sub-',gName,'0',subName,'_ses-2_task-SPEECH_audio.wav'));
sfile = fullfile(ses_folder, strcat('sub-',gName,'0',subName,'_ses-2_task-SPEECH_timestamp.txt'));
time = strings(4,1);
...
%% Instruction
% inst img
img_file = imread(fullfile(pwd, 'Inst', 'SPEECH', 'Inst.jpg'));
